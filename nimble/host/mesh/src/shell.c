...
struct shell_cmd_help cmd_ttl_help = {
	...
	struct shell_cmd_help cmd_cdb_add_help = {
		NULL, "<UUID> <addr> <num-elem> "
		      "<NetKeyIdx> [DevKey]", NULL
	};
	struct shell_cmd_help cdb_node_del_help = {
		NULL, "<addr>", NULL
	};
...
static const struct shell_cmd mesh_commands[] = {
    ...
    },
	{
        .sc_cmd = "cdb-node-add",
        .sc_cmd_func = cmd_cdb_create,
        .help = &cmd_cdb_add_help,
    },
	{
        .sc_cmd = "cdb-node-del",
        .sc_cmd_func = cmd_cdb_node_del,
        .help = &cdb_node_del_help,
    },
	{
        .sc_cmd = "cdb-subnet-add",
        .sc_cmd_func = cmd_subnet_add,
